...
(function() {
  var activate, deactivate, escapeHtml, fs, odog, openCustomDocument, path, resolveCustomEditor, updateWebview, vscode;
  ...
  updateWebview = function(webviewPanel, filePath) {
    ...
    return webviewPanel.webview.html = `<h1> 贱狗只读展示, 请于分栏编辑文件: ${path.basename(filePath)}</h3> <p><small>Updated: ${new Date().toLocaleTimeString()}</small></p>
